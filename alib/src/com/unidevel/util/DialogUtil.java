...
public class DialogUtil {
	...
	class CancelCallback implements DialogInterface.OnClickListener,
	...
	public void alert(String message) {
		alert(context.getString(android.R.string.dialog_alert_title), message,
				null);
	}
	...
	public void alert(String title, String message, Throwable ex) {
		...
		builder.setPositiveButton(android.R.string.ok, this.cancelCallback)
				.setOnCancelListener(this.cancelCallback);
		builder.create().show();
	}
	...
	public void confirm(String title, String message, final Runnable callback) {
		...
		builder.setPositiveButton(android.R.string.yes,
				...
				}).setNegativeButton(android.R.string.no, this.cancelCallback)
				.setOnCancelListener(this.cancelCallback);
		builder.create().show();
	}
	...
	public void prompt(String title, int inputType,
			final OnPromptCallback callback) {
		this.prompt(title, null, inputType, callback);
	}

	public void prompt(String title, String initialValue,
			final OnPromptCallback callback) {
		this.prompt(title, initialValue, InputType.TYPE_CLASS_TEXT, callback);
	}

	public void prompt(String title, String initialValue, int inputType,
			final OnPromptCallback callback) {
		AlertDialog.Builder builder = new AlertDialog.Builder(this.context);
		if (title != null)
			builder.setTitle(title);
