...
//        mItemHeightExpanded = res.getDimensionPixelSize(R.dimen.expanded_height);
    ...
    private void startDragging(Bitmap bm, int y) {
        ...
        ImageView v = new ImageView(super.getContext());
        int backGroundColor = super.getContext().getResources().getColor(R.color.dragndrop_background);
        v.setBackgroundColor(backGroundColor);
        v.setImageBitmap(bm);
        mDragBitmap = bm;

        mWindowManager = (WindowManager)super.getContext().getSystemService("window");
    ...
    private void stopDragging() {
        if (mDragView != null) {
            WindowManager wm = (WindowManager)super.getContext().getSystemService("window");
