...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener
{
	...
	void assertConfigured( String operation )
	{
		...
		{
			String error =
					"GameHelper error: Operation attempted without setup: " + operation
	...
	{
		debugLog( "onActivityResult: req=" + (requestCode == RC_RESOLVE
				? "RC_RESOLVE"
	...
	{
		debugLog( "Notifying LISTENER of sign-in " + (success
				? "SUCCESS"
	...
	public static void showFailureDialog( Activity activity, int actResp, int errorCode )
	{
		...
		switch (actResp)
		{
			...
			case GamesActivityResultCodes.RESULT_LICENSE_FAILED:
				...
				break;
			default:
				// No meaningful Activity response code, so generate default
				// Google
