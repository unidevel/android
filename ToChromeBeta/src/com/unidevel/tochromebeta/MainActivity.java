...
public class MainActivity extends Activity implements OnItemClickListener {
	...
	public static void startChromeInternal(Context context, String pkgName, String clsName, Uri uri) {
		...
		try {
			...
			try {
				...
				Toast.makeText(context, R.string.install_chrome, Toast.LENGTH_LONG)
						.show();
			}
		}
	}
	...
	public static void startChrome(Context context, Uri uri) {
		startChromeInternal(context, "com.chrome.beta",
